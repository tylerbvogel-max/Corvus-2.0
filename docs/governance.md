...
Corvus is a **prompt preparation system** for LLM queries in regulated industries. It does not make autonomous decisions — it assembles context to improve LLM answer quality while reducing cost.
...
| Hallucination pass-through | **Low** | Corvus enriches context but cannot prevent LLM hallucination; human review required |
