...
### 1.2 What Corvus Does NOT Control

| Component | Owner | Risk to Corvus |
|-----------|-------|-------------------|
...
| User interpretation of answers | End user | **High** — Corvus cannot enforce human review |
...
| If Corvus scales to... | New risks introduced |
|---------------------------|---------------------|
