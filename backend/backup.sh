#!/usr/bin/env bash
# Corvus automated backup — runs every 2 weeks via cron
...
DB_PATH="$HOME/Projects/corvus/backend/corvus.db"
GDRIVE_DIR="/mnt/chromeos/GoogleDrive/MyDrive/corvus-backups"
REPO_DIR="$HOME/Projects/corvus"
LOG_FILE="$HOME/Projects/corvus/backend/backup.log"
