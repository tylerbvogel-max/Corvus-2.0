  ...
  return (
    <div className="about-page">
      ...
      <CollapsibleSection title="The Problem">
        <p>
          Corvus currently treats all neurons as fungible &mdash; a neuron is a neuron.
          ...
          The absence of these specialized types in Corvus creates specific, observable problems:
        </p>
  ...
  → Assemble top-K → Execute`}</pre>
      ...
      <CollapsibleSection title="Biological Neuron Types → System Analogues">
        ...
        <table className="about-table">
          <thead>
            <tr><th>Biological</th><th>Corvus Analogue</th><th>Status</th></tr>
          </thead>
          <tbody>
            <tr>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                segment &mdash; uniquely powerful veto authority. In Corvus: pairwise embedding comparison within
...
INHIBITION_ENABLED=true           # false → revert to static diversity floor`}</pre>
      ...
      <CollapsibleSection title="Completed Work">
        ...
        <ul className="about-features">
          ...
          <li><strong>Semantic candidate selection</strong> &mdash; All neurons above <code>min_similarity</code> threshold are scored. No artificial pool cap &mdash; the semantic prefilter&rsquo;s similarity floor is the natural cutoff. At 100K neurons the matrix multiply is ~5&ndash;10ms; swap to FAISS/ANN index if neuron count exceeds 1M.</li>
