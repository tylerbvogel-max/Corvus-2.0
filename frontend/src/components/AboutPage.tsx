  ...
  return (
    <div className="about-page">
      ...
      <section className="about-section">
        ...
        <p>
          Enterprise AI adoption faces four converging risks that Corvus is designed to address:
        </p>
        ...
        <div className="about-thesis-grid">
          <div className="about-thesis-card">
            ...
            <p>
              ...
              a well-contextualized cheap model produces equivalent results. Corvus proves the thesis:
          ...
          <div className="about-thesis-card">
            ...
            <p>
              ...
              Corvus's architecture is <strong>model-agnostic by design</strong> &mdash; the neuron graph,
          ...
          <div className="about-thesis-card">
            ...
            <p>
              ...
              Corvus provides full provenance aligned with these requirements:
          ...
          <div className="about-thesis-card">
            ...
            <p>
              Corvus&rsquo;s design philosophy: <strong>be selfish with the context window.</strong> The context
      ...
      <section className="about-section">
        ...
        <p>
          Not all knowledge is created equal. Corvus distinguishes between three categories of knowledge,
  ...
  gate = clamp(relevance / threshold, floor, 1.0)
      ...
      <section className="about-section">
        ...
        <p className="about-note">
          ...
          {' '}<code>github.com/tylerbvogel-max/corvus</code>.
        </p>
      </section>
