  ...
  return (
    <div className="next-steps">
      ...
      <section className="next-steps-section">
        ...
        <span className="status-badge planned">Backlog</span>
        <p>
          Corvus currently operates as a single-shot system: classify, score, assemble, execute, done.
        ...
        <p>
          ...
          the full Corvus context already loaded. This preserves the &ldquo;selfish prompt&rdquo;
        ...
        <p>
          ...
          knowledge the system already assembled. Option A is simpler and keeps Corvus focused
