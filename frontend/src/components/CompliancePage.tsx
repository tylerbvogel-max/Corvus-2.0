...
export default function CompliancePage() {
  ...
  const items: ComplianceItem[] = [
    ...
    { id: 'MEA-2.9', title: 'Model Explainability', status: 'addressed', group: 'Transparency',
      detail: '6-signal gated scoring is inherently interpretable. Spread activation visible.',
    ...
    { id: 'SOC-PI', title: 'Processing Integrity', status: 'addressed', group: 'SOC 2',
      detail: 'Neuron scoring is deterministic and auditable. 6-signal gated scoring with baselines. Output grounding checks. Compliance audit with validation.',
