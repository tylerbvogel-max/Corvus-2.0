    ...
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '32px 24px' }}>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <div className="result-card" style={{ marginBottom: 12, padding: '14px 18px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 8 }}>
            ...
            <span style={{ fontSize: '1.1rem', fontWeight: 700, color: 'var(--accent)' }}>$340K &ndash; $480K</span>
          </div>
          <p style={{ color: 'var(--text-dim)', fontSize: '0.82rem', lineHeight: 1.6, marginBottom: 8 }}>
            Estimated 1,700&ndash;2,200+ hours of senior-level engineering at $150&ndash;$220/hr (blended US contractor rate for
            full-stack + AI/ML + domain expertise). This is what it would cost to hire someone to rebuild Corvus + Corvus from scratch.
          </p>
          <table className="score-table" style={{ fontSize: '0.78rem' }}>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>120&ndash;150</td>
                <td style={{ color: 'var(--text-dim)' }}>Burst, Impact, Precision, Novelty, Recency, Relevance with gated modulatory scoring, spread activation across co-firing graph, propagation logging, session heat continuity boost</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>Corvus &harr; Corvus integration</td>
                <td>40&ndash;60</td>
                <td style={{ color: 'var(--text-dim)' }}>Domain entity detection triggers Corvus context enrichment, observation-to-neuron pipeline with provenance, digest submission to neuron graph, configurable enrich modes (always/entities/never)</td>
              </tr>
              <tr>
                <td>Session intelligence + conversational persistence</td>
                <td>40&ndash;60</td>
                <td style={{ color: 'var(--text-dim)' }}>Session heat (tiered STP boost), prior neuron ID accumulation, conversation context prompt injection, session trace storage for retrospective analysis, planned 7th signal (session affinity)</td>
              </tr>
              <tr>
                <td>Live pipeline streaming + neuron visualization</td>
                <td>60&ndash;80</td>
                <td style={{ color: 'var(--text-dim)' }}>SSE streaming with real-time stage events, D3 organic root-tree neuron visualization with phased animation (growing/blooming/spreading), seeded pseudo-random wobble, hover tooltips with full signal breakdown</td>
              </tr>
              <tr>
                <td>NASA software engineering compliance</td>
                <td>40&ndash;60</td>
                <td style={{ color: 'var(--text-dim)' }}>JPL Power of Ten rules (10 controls), NPR 7150.2D requirements (10 controls), automated static analysis providers, git traceability checks, pre-commit hooks, 20-control compliance dashboard</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>140&ndash;180</td>
                <td style={{ color: 'var(--text-dim)' }}>37+ components, graph visualization, heatmap, chord diagram, 3D neuron universe, department explorer, query interface, eval dashboard, compliance pages, monetization analysis, end-user strategy, organic neuron root-tree viz</td>
              </tr>
              <tr>
          ...
          <div style={{ fontSize: '0.75rem', color: 'var(--text-dim)', marginTop: 8, fontStyle: 'italic' }}>
            Low end: 1,700 hrs &times; $160/hr = $272K, padded to $340K for project management overhead.
            High end: 2,200 hrs &times; $200/hr = $440K, padded to $480K. Corvus adds ~360 hours (screen capture, interpretation,
            Chrome extension, Corvus integration). Session intelligence, live pipeline streaming, D3 neuron visualization,
            and NASA compliance framework add ~200 additional hours. Rates reflect senior engineers with AI/ML pipeline
        ...
        <div className="result-card" style={{ marginBottom: 12, padding: '14px 18px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 8 }}>
            ...
            <span style={{ fontSize: '1.1rem', fontWeight: 700, color: 'var(--accent)' }}>$900K &ndash; $1.9M</span>
          </div>
          <p style={{ color: 'var(--text-dim)', fontSize: '0.82rem', lineHeight: 1.6, marginBottom: 8 }}>
            IP sale value is typically 2&ndash;4x development cost, reflecting the buyer&apos;s avoided risk, time-to-market
            acceleration, and the value of a working system vs. a greenfield build. With Corvus + session intelligence, the multiplier is driven
            higher by demonstrable labor-displacement ROI and conversational depth &mdash; a buyer isn&apos;t just acquiring a knowledge retrieval system,
            they&apos;re acquiring a workforce augmentation platform with quantifiable payback and session-aware context that deepens with use:
          </p>
          <ul style={{ paddingLeft: 20, color: 'var(--text-dim)', fontSize: '0.8rem', lineHeight: 1.7, marginBottom: 8 }}>
            ...
            <li><strong style={{ color: 'var(--text)' }}>Session intelligence</strong> &mdash; Conversational neuron persistence with tiered session heat (STP), conversation context prompt injection, and session trace analytics. Conversations get smarter the deeper they go &mdash; a fundamentally different UX from stateless RAG systems. Session traces feed retrospective learning without corrupting graph statistics.</li>
            <li><strong style={{ color: 'var(--text)' }}>NASA software engineering compliance</strong> &mdash; JPL Power of Ten + NPR 7150.2D with 20 automated control providers, pre-commit hooks, and a live compliance dashboard. Demonstrates engineering rigor at a level most startups never reach.</li>
          </ul>
          <div style={{ fontSize: '0.75rem', color: 'var(--text-dim)', fontStyle: 'italic' }}>
            Low end: ~2.6x development cost ($340K &times; 2.6 &asymp; $900K). High end: ~4.0x ($480K &times; 4.0 &asymp; $1.9M).
        ...
        <div className="result-card" style={{ marginBottom: 12, padding: '14px 18px' }}>
          ...
          <table className="score-table" style={{ fontSize: '0.78rem', marginBottom: 8 }}>
            ...
            <tbody>
              <tr>
                ...
                <td>$5K</td>
                <td style={{ color: 'var(--text-dim)' }}>Neuron graph queries, MCP IDE integration, structural fast path (zero-cost lookups), 6-signal scoring pipeline, conversational session heat, basic compliance dashboard</td>
              ...
              <tr>
                ...
                <td>$8K</td>
                <td style={{ color: 'var(--text-dim)' }}>+ Corvus screen monitoring (single seat), autopilot gap detection, drift monitoring, evaluation framework, per-project caching, auto-clustering insights, batch ingestion, session trace analytics, live pipeline visualization</td>
              ...
              <tr>
                ...
                <td>$12.5K</td>
                <td style={{ color: 'var(--text-dim)' }}>+ Multi-seat Corvus deployment, org-scoped tenant isolation, RBAC on neurons, full NIST/AIUC-1/NASA compliance posture, regulatory monitoring, transparency reports, custom neuron graphs, session affinity signal, cross-session pattern mining</td>
          ...
          <div style={{ fontSize: '0.75rem', color: 'var(--text-dim)', fontStyle: 'italic', marginBottom: 8 }}>
            ...
            generates incremental labor savings at near-zero marginal cost. Customers who buy one seat for Corvus expand
        ...
        <div className="result-card" style={{ marginBottom: 12, padding: '14px 18px' }}>
          ...
          <table className="score-table" style={{ fontSize: '0.78rem', marginBottom: 8 }}>
            <thead><tr><th>Multiple Driver</th><th>Impact</th><th>Corvus + Corvus Position</th></tr></thead>
            <tbody>
              <tr>
              ...
              <tr>
                <td style={{ fontWeight: 600 }}>Session intelligence moat</td>
                <td>&uarr; multiple</td>
                <td style={{ color: 'var(--text-dim)' }}>Conversations that deepen with use create a qualitative gap vs. stateless RAG competitors. Session traces generate implicit quality signals that improve the graph over time &mdash; a flywheel that competitors can&apos;t replicate without the same architectural investment</td>
              </tr>
              <tr>
                <td style={{ fontWeight: 600 }}>Multi-product platform</td>
                <td>&uarr; multiple</td>
                <td style={{ color: 'var(--text-dim)' }}>Two distinct product surfaces (Corvus knowledge retrieval + Corvus continuous monitoring) sharing infrastructure. Multi-product SaaS commands higher multiples because it creates multiple expansion vectors and reduces single-product concentration risk</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>&uarr; multiple</td>
                <td style={{ color: 'var(--text-dim)' }}>MCP server turns Corvus into developer infrastructure (not just a SaaS app). Dev tools companies (Snyk, Vercel, Postman) command 8&ndash;15x at growth stage</td>
              </tr>
              <tr>
      ...
      <section style={{ marginBottom: 32 }}>
          ...
          <table className="score-table" style={{ fontSize: '0.78rem', marginBottom: 8 }}>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style={{ color: 'var(--text-dim)' }}>Vision/OCR captures live screen content; interpretation engine synthesizes across app boundaries; cross-app entity tracking surfaces recurring themes; Corvus enrichment injects domain context automatically</td>
              ...
              <tr>
                ...
                <td style={{ color: 'var(--text-dim)' }}>Domain pattern detection (AS9100, NADCAP, ISO references); Corvus neuron graph validates institutional knowledge against live screen content; provenance tracking maintains full audit chain</td>
                <td style={{ fontWeight: 600, color: '#22c55e' }}>$42K</td>
              </tr>
            </tbody>
          </table>
          ...
          <table className="score-table" style={{ fontSize: '0.78rem', marginBottom: 8 }}>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style={{ color: 'var(--text-dim)' }}>Domain pattern detection fires on 10+ regulatory patterns; Corvus enrichment provides instant institutional context for any detected standard</td>
        ...
        <div className="result-card" style={{ padding: '14px 18px' }}>
          ...
          <p style={{ color: 'var(--text-dim)', fontSize: '0.82rem', lineHeight: 1.6, marginBottom: 8 }}>
            ...
            itself within one quarter and generates compounding ROI as the neuron graph deepens and Corvus enrichment
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12, marginBottom: 16 }}>
          {[
            ...
            { label: 'Frontend Components', value: '37+', sub: 'React + TypeScript + D3 + SSE' },
            { label: 'Backend Services', value: '17', sub: 'Scoring, classification, MCP, caching' },
            { label: 'Scoring Signals', value: '6 (+1)', sub: '6 active + Session Affinity planned' },
            { label: 'API Routers', value: '7', sub: 'REST endpoints + SSE streaming' },
            ...
            { label: 'Compliance Frameworks', value: '4', sub: 'NIST AI RMF, AIUC-1, ISO 42001, NASA' },
          ].map(stat => (
        ...
        <div className="result-card" style={{ padding: '12px 16px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4px 24px', fontSize: '0.8rem', color: 'var(--text-dim)' }}>
            <div>6-signal gated modulatory scoring engine</div>
            ...
            <div>Session heat (STP continuity boost)</div>
            <div>Conversation context prompt injection</div>
            <div>Prior neuron ID accumulation + persistence</div>
            <div>SSE streaming with live pipeline stages</div>
            <div>D3 organic root-tree neuron visualization</div>
            ...
            <div>Z-score drift detection (6 signals)</div>
            <div>Model registry with cost tracking</div>
            <div>PostgreSQL with multi-tenant user_id columns</div>
            <div>D3 visualizations (graph, heatmap, chord, 3D)</div>
            <div>NIST/AIUC-1/ISO 42001 compliance tracking</div>
            <div>NASA JPL Power of Ten + NPR 7150.2D (20 controls)</div>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <div className="result-card" style={{ marginBottom: 12 }}>
          ...
          <p style={{ color: 'var(--text-dim)', fontSize: '0.85rem', lineHeight: 1.6 }}>
            ...
            Current posture: {'>'}50% addressed or partial. Completing certification would make Corvus one of the
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <div className="result-card" style={{ marginBottom: 12 }}>
          ...
          <p style={{ color: 'var(--text-dim)', fontSize: '0.85rem', lineHeight: 1.6 }}>
            Corvus exposes its full pipeline as an MCP (Model Context Protocol) server. Claude Code, Cursor, and
            other MCP-capable IDEs can call directly into the neuron graph for context enrichment without HTTP
            round-trips. This positions Corvus as infrastructure that plugs into the developer's existing
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <div className="result-card" style={{ marginBottom: 12 }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, color: 'var(--text-dim)', fontSize: '0.85rem' }}>
            <div><strong style={{ color: 'var(--text)' }}>Streaming responses (SSE)</strong> <span style={{ fontSize: '0.7rem', padding: '2px 8px', borderRadius: 3, background: '#22c55e22', color: '#22c55e', marginLeft: 6 }}>DONE</span> &mdash; Real-time pipeline stage events with live neuron tree growth animation</div>
            <div><strong style={{ color: 'var(--text)' }}>Tiered session heat (1.3&times;/1.6&times;/2.0&times;)</strong> &mdash; Replace flat continuity boost with fire-count-based tiers for deeper conversational drilling</div>
            <div><strong style={{ color: 'var(--text)' }}>Session trace storage + analytics</strong> &mdash; Append-only conversation digests for retrospective pattern mining by autopilot</div>
            <div><strong style={{ color: 'var(--text)' }}>Session affinity signal (7th signal)</strong> &mdash; Neurons users consistently drill into across sessions get a new scoring signal</div>
            <div><strong style={{ color: 'var(--text)' }}>Cost forecasting</strong> &mdash; &ldquo;This query configuration will cost ~$X based on historical patterns&rdquo;</div>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <div className="result-card">
          <ol style={{ paddingLeft: 20, color: 'var(--text-dim)', fontSize: '0.85rem', lineHeight: 2 }}>
            ...
            <li><strong style={{ color: 'var(--text)' }}>Session intelligence (tiered heat + traces)</strong> &mdash; conversations that get smarter with depth, retrospective pattern mining for graph improvement</li>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <div className="result-card">
          <p style={{ color: 'var(--text-dim)', fontSize: '0.85rem', lineHeight: 1.6, marginBottom: 12 }}>
            Most AI startups treat compliance as a checkbox they'll handle later. Corvus is building it into the
      ...
      <section>
        ...
        <div className="result-card">
          ...
          <ul style={{ paddingLeft: 20, color: 'var(--text-dim)', fontSize: '0.85rem', lineHeight: 1.8 }}>
            <li>6-signal gated modulatory scoring engine (Burst, Impact, Precision, Novelty, Recency, Relevance)</li>
            <li>Session heat (short-term potentiation) &mdash; ephemeral continuity boost that deepens conversations without corrupting graph statistics</li>
            <li>Conversation context prompt injection &mdash; prior neuron summaries assembled into system prompt for cross-turn awareness</li>
            ...
            <li>SSE streaming with live pipeline stage events + D3 organic root-tree neuron visualization</li>
            ...
            <li>NASA JPL Power of Ten + NPR 7150.2D compliance with 20 automated control providers and pre-commit hooks</li>
