export default function Iso42001Page() {
  ...
  const annexAItems: IsoItem[] = [
    ...
    { id: 'A.6.1.2', title: 'AI System Design Documentation', status: 'addressed',
      detail: 'System card documents full architecture: two-stage pipeline, 6-layer neuron hierarchy, 6-signal gated scoring, spread activation, token-budgeted assembly.',
    ...
    { id: 'A.8.2', title: 'Transparent AI System Information', status: 'addressed',
      detail: '6-signal gated scoring is inherently interpretable. Spread activation paths visible. Neuron content inspectable. Token budgets transparent. UI built around inspecting AI decision-making.',
  ...
  return (
    <div className="security-page">
      ...
      {renderSection(
        ...
        'Top management commitment, AI policy establishment, and organizational role assignment. Corvus\u2019s governance documentation covers these foundational requirements.',
        leadershipItems
      )}
      ...
      <section className="security-section">
        ...
        <div className="result-card" style={{ fontSize: '0.85rem', color: 'var(--text-dim)', lineHeight: 1.7 }}>
          <p style={{ marginBottom: 12 }}>
            ...
            and logging (A.6.2.8) are well-addressed thanks to Corvus&rsquo;s provenance-first architecture.
