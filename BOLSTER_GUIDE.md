# Corvus Role Bolster Guide

## Project Context

Corvus is a biomimetic neuron graph for prompt preparation in a defense/aerospace manufacturing context. It uses a 6-layer hierarchy:
...
python3 -c "
import sqlite3
conn = sqlite3.connect('corvus.db')
